  ...
  <body>
      ...
      <div class="container-sm">
        ...
        <div class="collapse-sm navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav ms-auto">
            <a class="nav-link  active me-4" aria-current="page" href="#home"><b>Home</b></a>
            <a class="nav-link  active me-4" href="#about"><b>About</b></a>
            <a class="nav-link  active me-4" href="#gallery"><b>Gallery</b></a>
    ...
    <div class="container-sm" style="margin-top: px;">
      ...
      <div class="col-sm justify-content text-center fs-5">
        <p class="col-sm"><?php echo $profil['about'] ?></p>
      </div>
    </div>
       ...
       <div class="row">
         <div class="col-md-4 mb-3">
          <div class="card shadow-sm" style="width: 100%;">
            <img src="img/forest.jpeg" class="card-img-top" alt="">
            <div class="card-body">
   ...
   <div class="container-sm">
    ...
    <div class="form-group mb-3">
      ...
      <textarea id="comment" class="form-control" name="comment" rows="3" placeholder="Komentar disini"></textarea>
    </div>
    <input name="kirim" id="kirim" class="btn btn-outline-primary" type="button" value="Kirim" style="width: 100%;">
   </div>
